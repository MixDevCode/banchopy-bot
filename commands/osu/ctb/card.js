    ...
    run: async(client, message, args) => {
        if (!args[0]) {
            ...
            let {star_avg, aim_avg, speed_avg, acc_avg,
                finger_control_avg, calc_count} = await calcPlayer(message, userSchema.username, 2)
            ...
            const path_suffix = 'akatsuki_ctb'
            ...
            function card_stat(onlycard) {
                ...
                if (onlycard) {
                    for (let num of modenum_skill[2].skill) {
            ...
            let {star_avg, aim_avg, speed_avg, acc_avg,
                finger_control_avg, calc_count} = await calcPlayer(message, username, 2)
