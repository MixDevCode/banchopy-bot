...
module.exports = {
    name: 'maniatop',
    aliases: ['mtop'],
    description: "Get user's top osu mania plays.",
    usage: 'maniatop [username...]',
    options: [
        ...
        if (!args[0]) {
            ...
            if(data.length > 1) {
                const embeds = data.map((x) => {
                    return new MessageEmbed()
                        .setAuthor({ name: `Top ${bestInfo.scores.length} osu!Mania plays for ${playerInfo.player.info.name}`, iconURL: `${botConfig.server.avatarurl}${playerInfo.player.info.id}?${Math.floor(Math.random()*9999)}` })
                        .setColor("#0099ff")
                        .setDescription(x)
                ...
                const embed = new MessageEmbed({
                    color: '#0099ff',
                    author: {
                        name: `Top ${bestInfo.scores.length} osu!Mania plays for ${playerInfo.player.info.name}`,
            ...
            if (parameters.contains == true && parameters.hasUser == true) {
                ...
                const embed = new MessageEmbed({
                    color: '#0099ff',
                    author: {
                        name: `Top 5 osu!Mania plays for ${playerInfo.player.info.name} sorted by play time`,
                        icon_url: `${botConfig.server.avatarurl}${playerInfo.player.info.id}?${Math.floor(Math.random()*9999)}`
                    },
                    description: description,
                    thumbnail: {
                ...
                const embed = new MessageEmbed({
                    color: '#0099ff',
                    author: {
                        name: `Random best osu!Mania play for ${playerInfo.player.info.name}`,
                        icon_url: `${botConfig.server.avatarurl}${playerInfo.player.info.id}?${Math.floor(Math.random()*9999)}`
                    },
                    description: `${randnum+1}. ${stars(modsFixed[0].difficultyrating, bestInfo.scores[randnum].beatmap.mode)} **[${bestInfo.scores[randnum].beatmap.title}](https://osu.ppy.sh/beatmapsets/${bestInfo.scores[randnum].beatmap.set_id}#osu/${bestInfo.scores[randnum].beatmap.id})** (${Number((parseFloat(modsFixed[0].difficultyrating)).toFixed(2))}★) \`${modsEnum({mod: bestInfo.scores[randnum].mods}).mod_text}\` • ${scoreFormat(bestInfo.scores[randnum].score)}\n${ranks(bestInfo.scores[randnum].grade)} *${bestInfo.scores[randnum].beatmap.version}* • **${Number((bestInfo.scores[randnum].pp).toFixed(2))}pp** • x${bestInfo.scores[randnum].max_combo}/${bestInfo.scores[randnum].beatmap.max_combo}\n${Number((bestInfo.scores[randnum].acc).toFixed(2))}% \`[ ${bestInfo.scores[randnum].ngeki} • ${bestInfo.scores[randnum].n300} • ${bestInfo.scores[randnum].nkatu} • ${bestInfo.scores[randnum].n100} • ${bestInfo.scores[randnum].n50} • ${bestInfo.scores[randnum].nmiss} ]\``,
                    thumbnail: {
                ...
                const embed = new MessageEmbed({
                    color: '#0099ff',
                    author: {
                        name: `Top osu!Mania play n° ${index+1} for ${playerInfo.player.info.name}`,
                        icon_url: `${botConfig.server.avatarurl}${playerInfo.player.info.id}?${Math.floor(Math.random()*9999)}`
                    },
                    description: `${index+1}. ${stars(modsFixed[0].difficultyrating, bestInfo.scores[index].beatmap.mode)} **[${bestInfo.scores[index].beatmap.title}](https://osu.ppy.sh/beatmapsets/${bestInfo.scores[index].beatmap.set_id}#osu/${bestInfo.scores[index].beatmap.id})** (${Number((parseFloat(modsFixed[0].difficultyrating)).toFixed(2))}★) \`${modsEnum({mod: bestInfo.scores[index].mods}).mod_text}\` • ${scoreFormat(bestInfo.scores[index].score)}\n${ranks(bestInfo.scores[index].grade)} *${bestInfo.scores[index].beatmap.version}* • **${Number((bestInfo.scores[index].pp).toFixed(2))}pp** • x${bestInfo.scores[index].max_combo}/${bestInfo.scores[index].beatmap.max_combo}\n${Number((bestInfo.scores[index].acc).toFixed(2))}% \`[ ${bestInfo.scores[index].ngeki} • ${bestInfo.scores[index].n300} • ${bestInfo.scores[index].nkatu} • ${bestInfo.scores[index].n100} • ${bestInfo.scores[index].n50} • ${bestInfo.scores[index].nmiss} ]\``,
                    thumbnail: {
                ...
                if(data.length > 1) {
                    ...
                    const embed = new MessageEmbed({
                        color: '#0099ff',
                        author: {
                            name: `${bestInfo.scores.length} osu!Mania plays for ${playerInfo.player.info.name} matching "${search}"`,
                            icon_url: `${botConfig.server.avatarurl}${playerInfo.player.info.id}?${Math.floor(Math.random()*9999)}`
                        },
                        description: description,
                        thumbnail: {
                ...
                const embed = new MessageEmbed({
                    color: '#0099ff',
                    author: {
                        name: `Top 5 osu!Mania plays for ${playerInfo.player.info.name}`,
                        icon_url: `${botConfig.server.avatarurl}${playerInfo.player.info.id}?${Math.floor(Math.random()*9999)}`
                    },
                    description: description,
                    thumbnail: {
