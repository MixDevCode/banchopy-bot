...
module.exports = {
    name: 'leaderboard',
    aliases: ['lb'],
    description: 'Get the best 10 osu!standard users in the server.',
    usage: 'leaderboard',
    /** 
     * @param {Client} client 
    ...
    run: async(client, message, args) => {
        ...
        const embed = new MessageEmbed({
            color: '#0099ff',
            title: `Top ${leaderboard.leaderboard.length} osu!players in the server`,
            url: `${botConfig.server.domainurl}leaderboard/std/pp/vn`,
            fields: [{
                name: '\u200b',
                value: `\*\*${positions}\*\*`,
                inline: true
